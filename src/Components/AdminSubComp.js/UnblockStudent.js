...
const UnblockStudent = () => {
    ...
    const handleUnblock = async(e) => {
      if(!id){
        ...
        e.preventDefault();
        api.delete(`/admin/user/unblock/${id}`,{params:{
          id
        }}).then((res) => {
          console.log(res);
  ...
  return (
    ...
    >
     <Card style={{ width: '25rem'}}>
       ...
       <Card.Body>
        <Card.Title style={{marginBottom:"3rem",display:"flex",justifyContent:"center",overflowY:"hidden"}}>Unblock User</Card.Title>
        ...
        <div className="button" style={{width:"100%",display:"flex",justifyContent:"center"}}><Button variant="secondary" onClick={handleUnblock}>Unblock</Button></div>
